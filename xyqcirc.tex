...
\def\w{\ar@{-}[l]}
\def\c{\ar@{=}[l]}
\def\W{\ar@{-}[l]<-.07ex> \ar@{-}[l]<-.07ex> \ar@{-}[l]}
\def\C{\ar@{=}[l]<-.07ex> \ar@{=}[l]<-.07ex> \ar@{=}[l]}
\def\d{\ar@{.}[l]}
...
\def\qrule{\rule[-0.2ex]{0ex}{2.1ex}}
\def\q#1{|#1\>}
\def\qv#1#2{*+{\qrule|#1\>=|#2\>}}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% multiple qubit gates

% utility text box for figuring out width of things
\newbox{\sbox}
